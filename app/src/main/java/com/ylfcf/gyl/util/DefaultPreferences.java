...
import com.ylfcf.gyl.ui.MyApplication;
...
public abstract class DefaultPreferences {
    ...
    private static void init() {
        try {
            PackageInfo packageInfo = MyApplication.getApplication().getPackageManager()
                    .getPackageInfo(MyApplication.getApplication().getPackageName(),
